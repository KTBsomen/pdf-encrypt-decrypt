...
//
extern char* EncryptPDF(unsigned char* pdfBufferPtr, int pdfBufferSize, char* userPwStr, char* ownerPwStr, char* permissionsStr);
...
//
extern char* DecryptPDF(unsigned char* pdfBufferPtr, int pdfBufferSize, char* passwordStr, char* ownerPwStr);
